...
export function pluginReplaceIcons(): Plugin[] {
	return [
		...
		iconsReplace({
			...
			include: ["**/pages/**", "**/components/MkAuthConfirm.*"],
		}),
		iconsReplace({
			values: {
		...
		iconsReplace({
			...
			include: ["**/pages/settings/emoji-picker.*"],
		}),
		iconsReplace({
			values: {
				"ti ti-reload": "ph-arrows-clockwise ph-bold ph-lg",
			},
			include: ["**/pages/flash/flash.*", "**/components/MkPageWindow.*"],
		}),
		iconsReplace({
			values: {
