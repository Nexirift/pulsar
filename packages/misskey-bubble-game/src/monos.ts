...
export const NORAML_MONOS: Mono[] = [
	...
	},
	{
		...
		level: 9,
		sizeX:
			NORMAL_BASE_SIZE * 1.25 * 1.25 * 1.25 * 1.25 * 1.25 * 1.25 * 1.25 * 1.25,
		sizeY:
			NORMAL_BASE_SIZE * 1.25 * 1.25 * 1.25 * 1.25 * 1.25 * 1.25 * 1.25 * 1.25,
		shape: "circle",
		score: 256,
...
export const SQUARE_MONOS: Mono[] = [
	...
	},
	{
		...
		level: 9,
		sizeX:
			SQUARE_BASE_SIZE * 1.25 * 1.25 * 1.25 * 1.25 * 1.25 * 1.25 * 1.25 * 1.25,
		sizeY:
			SQUARE_BASE_SIZE * 1.25 * 1.25 * 1.25 * 1.25 * 1.25 * 1.25 * 1.25 * 1.25,
		shape: "rectangle",
		score: 256,
...
export const SWEETS_MONOS: Mono[] = [
	...
	},
	{
		...
		level: 9,
		sizeX:
			SWEETS_BASE_SIZE * 1.25 * 1.25 * 1.25 * 1.25 * 1.25 * 1.25 * 1.25 * 1.25,
		sizeY:
			SWEETS_BASE_SIZE * 1.25 * 1.25 * 1.25 * 1.25 * 1.25 * 1.25 * 1.25 * 1.25,
		shape: "custom",
		vertices: [
