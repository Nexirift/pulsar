...
<template>
	<div v-show="!isDeleted" ref="rootEl" :class="$style.root">
		<EmNoteSub
		...
		<article :class="$style.note">
					...
					<div :class="$style.noteHeaderBodyUpper">
						<div style="min-width: 0">
							...
							<div :class="$style.noteHeaderUsername">
								<EmAcct :user="appearNote.user" />
							</div>
						</div>
						<div :class="$style.noteHeaderInfo">
							<a
								:href="url"
								:class="$style.noteHeaderInstanceIconLink"
								target="_blank"
							...
							>
								<img
									...
									alt=""
									:class="$style.noteHeaderInstanceIcon"
								/>
							</a>
						</div>
					</div>
			...
			<div
				:class="[$style.noteContent, { [$style.contentCollapsed]: collapsed }]"
			>
				...
				<div v-show="mergedCW == null || showContent">
					...
					<div v-if="appearNote.renote" :class="$style.quote">
						<EmNoteSimple :note="appearNote.renote" :class="$style.quoteNote" />
					</div>
					<button
			...
			<footer>
				...
				<a
					...
					target="_blank"
					rel="noopener"
					:class="[$style.noteFooterButton, $style.footerButtonLink]"
					class="_button"
				>
					<i class="ti ti-arrow-back-up"></i>
				</a>
