...
const ReconnectingWebSocketConstructor =
	ReconnectingWebSocket as unknown as typeof ReconnectingWebSocket.default;
	...
	implements IStream
{
	...
	constructor(
		...
		this.stream = new ReconnectingWebSocketConstructor(
