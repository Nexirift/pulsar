...
export type AdminFixUserCountsRequest = operations['admin___fix-user-counts']['requestBody']['content']['application/json'];
export type AdminFixUserCountsResponse = operations['admin___fix-user-counts']['responses']['200']['content']['application/json'];
export type AdminForceAdultsOnlyStatusRequest = operations['admin___force-adults-only-status']['requestBody']['content']['application/json'];
...
export type AdminUnforceAdultsOnlyStatusRequest = operations['admin___unforce-adults-only-status']['requestBody']['content']['application/json'];
...
export type MyAppsDeleteRequest = operations['my___apps___delete']['requestBody']['content']['application/json'];
export type MyAppsRotateSecretRequest = operations['my___apps___rotate-secret']['requestBody']['content']['application/json'];
export type MyAppsRotateSecretResponse = operations['my___apps___rotate-secret']['responses']['200']['content']['application/json'];
export type MyAppsUpdateRequest = operations['my___apps___update']['requestBody']['content']['application/json'];
export type MyAppsUpdateResponse = operations['my___apps___update']['responses']['200']['content']['application/json'];
...
export type TenorFeaturedRequest = operations['tenor___featured']['requestBody']['content']['application/json'];
export type TenorFeaturedResponse = operations['tenor___featured']['responses']['200']['content']['application/json'];
export type TenorSearchRequest = operations['tenor___search']['requestBody']['content']['application/json'];
export type TenorSearchResponse = operations['tenor___search']['responses']['200']['content']['application/json'];
