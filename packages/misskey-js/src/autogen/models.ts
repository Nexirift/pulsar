...
export type UserDetailedNotMeOnly =
...
export type AbuseReportNotificationRecipient =
	components["schemas"]["AbuseReportNotificationRecipient"];
export type ChatMessage = components["schemas"]["ChatMessage"];
export type ChatMessageLite = components["schemas"]["ChatMessageLite"];
export type ChatMessageLiteFor1on1 =
	components["schemas"]["ChatMessageLiteFor1on1"];
export type ChatMessageLiteForRoom =
	components["schemas"]["ChatMessageLiteForRoom"];
