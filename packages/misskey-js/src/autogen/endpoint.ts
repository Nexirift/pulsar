...
export type Endpoints = {
	...
	"admin/drive/clean-remote-files": {
		req: AdminDriveCleanRemoteFilesRequest;
		res: EmptyResponse;
	};
	...
	"admin/fix-user-counts": {
		req: AdminFixUserCountsRequest;
		res: AdminFixUserCountsResponse;
	};
	"admin/force-adults-only-status": {
		req: AdminForceAdultsOnlyStatusRequest;
		res: EmptyResponse;
	};
	...
	"admin/restart-migration": {
		req: AdminRestartMigrationRequest;
		res: AdminRestartMigrationResponse;
	};
	"admin/roles/annotate-condition": {
		req: AdminRolesAnnotateConditionRequest;
		res: AdminRolesAnnotateConditionResponse;
	};
	"admin/roles/assign": { req: AdminRolesAssignRequest; res: EmptyResponse };
	"admin/roles/clone": {
		req: AdminRolesCloneRequest;
		res: AdminRolesCloneResponse;
	};
	"admin/roles/create": {
	...
	"admin/unforce-adults-only-status": {
		req: AdminUnforceAdultsOnlyStatusRequest;
		res: EmptyResponse;
	};
	...
	"bubble-game/ranking": {
		req: BubbleGameRankingRequest;
		res: BubbleGameRankingResponse;
	};
	"bubble-game/register": {
		req: BubbleGameRegisterRequest;
		res: EmptyResponse;
	};
	"channels/create": {
	...
	"i/registry/get-unsecure": {
		req: IRegistryGetUnsecureRequest;
		res: EmptyResponse;
	};
	...
	"i/shared-access/list": {
		req: ISharedAccessListRequest;
		res: ISharedAccessListResponse;
	};
	"i/shared-access/login": {
		req: ISharedAccessLoginRequest;
		res: ISharedAccessLoginResponse;
	};
	"i/signin-history": {
	...
	"my/apps/rotate-secret": {
		req: MyAppsRotateSecretRequest;
		res: MyAppsRotateSecretResponse;
	};
	...
	"notes/bubble-timeline": {
		req: NotesBubbleTimelineRequest;
		res: NotesBubbleTimelineResponse;
	};
	...
	"notes/following": {
		req: NotesFollowingRequest;
		res: NotesFollowingResponse;
	};
	...
	"notes/schedule/create": {
		req: NotesScheduleCreateRequest;
		res: EmptyResponse;
	};
	"notes/schedule/delete": {
		req: NotesScheduleDeleteRequest;
		res: EmptyResponse;
	};
	"notes/schedule/list": {
		req: NotesScheduleListRequest;
		res: NotesScheduleListResponse;
	};
	...
	"reversi/show-game": {
		req: ReversiShowGameRequest;
		res: ReversiShowGameResponse;
	};
