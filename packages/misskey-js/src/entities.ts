...
export const exportEntityName = (i18n: any) =>
	({
		...
		ExportCompletedNotification["exportedEntity"],
		string
	>;

export const importEntityName = (i18n: any) =>
	exportEntityName(i18n) satisfies Record<
		ImportCompletedNotification["importedEntity"],
		string
	>;
