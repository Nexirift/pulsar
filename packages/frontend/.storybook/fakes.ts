...
export function role(
	...
	const prefix = params.displayOrder
		? params.displayOrder.toString().padStart(3, "0") + "-"
		: "";
...
export function emoji(
	...
	return {
		...
		roleIdsThatCanBeUsedThisEmojiAsReaction:
			params?.roleIdsThatCanBeUsedThisEmojiAsReaction ?? [],
		updatedAt: updatedAt,
	};
}
