...
export const definePage = (
	maybeRefOrGetterMetadata: MaybeRefOrGetter<PageMetadata>,
): void => {
...
export const provideMetadataReceiver = (
	receiver: PageMetadataReceiver,
): void => {
	setReceiver(receiver);
};

export const provideReactiveMetadata = (
	metadataRef: Ref<PageMetadata | null>,
): void => {
