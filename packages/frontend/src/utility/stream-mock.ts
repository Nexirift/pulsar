...
export class StreamMock extends EventEmitter<StreamEvents> implements IStream {
	...
	public useChannel<C extends keyof Channels>(
		...
		name?: string,
	): ChannelConnectionMock<Channels[C]> {
...
class ChannelConnectionMock<Channel extends AnyOf<Channels> = any>
	...
	implements IChannelConnection<Channel>
{
	...
	constructor(
		stream: IStream,
		...args: OmitFirst<
			ConstructorParameters<typeof Misskey.ChannelConnection<Channel>>
		>
	) {
		super();
