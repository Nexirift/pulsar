					...
					<div class="_woodenFrame" style="text-align: center">
						<div class="_woodenFrameInner">
							<div class="_gaps" style="padding: 16px">
								...
								<MkButton primary gradate large rounded inline @click="start">{{
									i18n.ts.start
								}}</MkButton>
							</div>
						</div>
					...
					<div class="_woodenFrame">
						<div class="_woodenFrameInner">
							<div class="_gaps_s" style="padding: 16px">
								<div>
									<b
										>{{ i18n.tsx.lastNDays({ n: 7 }) }} {{ i18n.ts.ranking }}</b
									>
...
const gameMode = ref<"normal" | "square" | "yen" | "sweets" | "space">(
	"normal",
);
...
watch(
	gameMode,
	async () => {
		ranking.value = await misskeyApiGet("bubble-game/ranking", {
