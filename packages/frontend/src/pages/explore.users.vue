		...
		<div v-if="origin === 'local'">
			<template v-if="tag == null">
				<MkFoldableSection class="_margin" persistKey="explore-pinned-users">
					<template #header
						><i class="ti ti-bookmark ti-fw" style="margin-right: 0.5em"></i
						>{{ i18n.ts.pinnedUsers }}</template
					>
					<MkUserList
						:pagination="pinnedUsers"
						:extractor="filterAdultsOnlyUsers"
					/>
				</MkFoldableSection>
				<MkFoldableSection class="_margin" persistKey="explore-popular-users">
					<template #header
						><i class="ti ti-chart-line ti-fw" style="margin-right: 0.5em"></i
						>{{ i18n.ts.popularUsers }}</template
					>
					<MkUserList
						:pagination="popularUsers"
						:extractor="filterAdultsOnlyUsers"
					/>
				</MkFoldableSection>
				<MkFoldableSection
				...
				>
					<template #header
						><i
							class="ph-chat-text ph-bold ph-lg ti-fw"
							style="margin-right: 0.5em"
						></i
						>{{ i18n.ts.recentlyUpdatedUsers }}</template
					>
					<MkUserList
						:pagination="recentlyUpdatedUsers"
						:extractor="filterAdultsOnlyUsers"
					/>
				</MkFoldableSection>
				<MkFoldableSection
				...
				>
					<template #header
						><i class="ti ti-plus ti-fw" style="margin-right: 0.5em"></i
						>{{ i18n.ts.recentlyRegisteredUsers }}</template
					>
					<MkUserList
						:pagination="recentlyRegisteredUsers"
						:extractor="filterAdultsOnlyUsers"
					/>
				</MkFoldableSection>
			</template>
			...
			<template v-if="tag == null">
				<MkFoldableSection class="_margin">
					<template #header
						><i class="ti ti-chart-line ti-fw" style="margin-right: 0.5em"></i
						>{{
							i18n.tsx.popularUsersLocal({ name: instance.name ?? host })
						}}</template
					>
					<MkUserList
						:pagination="popularUsersLocalF"
						:extractor="filterAdultsOnlyUsers"
					/>
				</MkFoldableSection>
				<MkFoldableSection class="_margin">
					<template #header
						><i class="ti ti-chart-line ti-fw" style="margin-right: 0.5em"></i
						>{{ i18n.ts.popularUsersGlobal }}</template
					>
					<MkUserList
						:pagination="popularUsersF"
						:extractor="filterAdultsOnlyUsers"
					/>
				</MkFoldableSection>
				<MkFoldableSection class="_margin">
					...
					>
					<MkUserList
						:pagination="recentlyUpdatedUsersF"
						:extractor="filterAdultsOnlyUsers"
					/>
				</MkFoldableSection>
				<MkFoldableSection class="_margin">
					<template #header
						><i class="ti ti-rocket ti-fw" style="margin-right: 0.5em"></i
						>{{ i18n.ts.recentlyDiscoveredUsers }}</template
					>
					<MkUserList
						:pagination="recentlyRegisteredUsersF"
						:extractor="filterAdultsOnlyUsers"
					/>
				</MkFoldableSection>
			</template>
