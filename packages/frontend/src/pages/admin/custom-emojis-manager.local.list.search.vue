...
<template>
	...
	>
		<template #header>
			<i class="ti ti-search" style="margin-right: 0.5em"></i>
			{{ i18n.ts.search }}
		</template>
		<div :class="$style.root">
			<div class="_spacer">
				<div class="_gaps">
					<div class="_gaps_s">
						<MkInput v-model="model.name" type="search" autocapitalize="off">
						...
						<MkInput v-model="model.aliases" type="search" autocapitalize="off">
							<template #label>aliases</template>
						</MkInput>

						<MkInput v-model="model.type" type="search" autocapitalize="off">
							<template #label>type</template>
						</MkInput>
						<MkInput v-model="model.license" type="search" autocapitalize="off">
							<template #label>license</template>
						</MkInput>
						<MkSelect v-model="model.sensitive">
						...
						<MkSelect v-model="model.localOnly">
...
const queryRolesText = computed(() =>
	model.value.roles.map((it) => it.name).join(","),
);
