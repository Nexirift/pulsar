			...
			<div class="_gaps">
				<div class="_panel" style="padding: 16px">
					<MkSwitch
						...
						@change="onChange_enableServerMachineStats"
					>
				...
				<div class="_panel" style="padding: 16px">
					<MkSwitch
						...
						@change="onChange_enableIdenticonGeneration"
					>
				...
				<div class="_panel" style="padding: 16px">
					<MkSwitch
						v-model="enableChartsForRemoteUser"
						@change="onChange_enableChartsForRemoteUser"
					>
				...
				<div class="_panel" style="padding: 16px">
					<MkSwitch
						v-model="enableStatsForFederatedInstances"
						@change="onChange_enableStatsForFederatedInstances"
					>
						<template #label>{{
				...
				<div class="_panel" style="padding: 16px">
					<MkSwitch
						v-model="enableChartsForFederatedInstances"
						@change="onChange_enableChartsForFederatedInstances"
					>
						<template #label>{{
				...
				<MkFolder :defaultOpen="true">
					...
					<template #label
						>Misskey® Fan-out Timeline Technology™ (FTT)</template
					>
					<template v-if="fttForm.savedState.enableFanoutTimeline" #suffix
						>Enabled</template
					>
					...
					<div class="_gaps">
						<MkSwitch v-model="fttForm.state.enableFanoutTimeline">
							<template #label
								>{{ i18n.ts.enable
									...
									v-if="fttForm.modifiedStates.enableFanoutTimeline"
									class="_modified"
						...
						<template v-if="fttForm.state.enableFanoutTimeline">
							<MkSwitch v-model="fttForm.state.enableFanoutTimelineDbFallback">
								<template #label
									>{{ i18n.ts._serverSettings.fanoutTimelineDbFallback
										...
										v-if="fttForm.modifiedStates.enableFanoutTimelineDbFallback"
										class="_modified"
										>{{ i18n.ts.modified }}</span
									></template
								>
							...
							<MkInput
								v-model="fttForm.state.perLocalUserUserTimelineCacheMax"
								type="number"
							>
								<template #label
									>perLocalUserUserTimelineCacheMax<span
										v-if="
											fttForm.modifiedStates.perLocalUserUserTimelineCacheMax
										"
										class="_modified"
										>{{ i18n.ts.modified }}</span
									></template
							...
							<MkInput
								v-model="fttForm.state.perRemoteUserUserTimelineCacheMax"
								type="number"
							>
								<template #label
									>perRemoteUserUserTimelineCacheMax<span
										v-if="
											fttForm.modifiedStates.perRemoteUserUserTimelineCacheMax
										"
										class="_modified"
										>{{ i18n.ts.modified }}</span
									></template
							...
							<MkInput
								v-model="fttForm.state.perUserHomeTimelineCacheMax"
								type="number"
							>
								<template #label
									>perUserHomeTimelineCacheMax<span
										v-if="fttForm.modifiedStates.perUserHomeTimelineCacheMax"
										class="_modified"
										>{{ i18n.ts.modified }}</span
									></template
								>
							...
							<MkInput
								v-model="fttForm.state.perUserListTimelineCacheMax"
								type="number"
							>
								<template #label
									>perUserListTimelineCacheMax<span
										v-if="fttForm.modifiedStates.perUserListTimelineCacheMax"
										class="_modified"
										>{{ i18n.ts.modified }}</span
									></template
								>
				...
				<MkFolder :defaultOpen="true">
					<template #icon><i class="ti ti-bolt"></i></template>
					<template #label
						>Misskey® Reactions Boost Technology™ (RBT)<span class="_beta">{{
							i18n.ts.beta
						}}</span></template
					>
					<template v-if="rbtForm.savedState.enableReactionsBuffering" #suffix
						>Enabled</template
					>
					<template v-else #suffix>Disabled</template>
						...
						<MkSwitch v-model="rbtForm.state.enableReactionsBuffering">
							<template #label
								>{{ i18n.ts.enable
									...
									v-if="rbtForm.modifiedStates.enableReactionsBuffering"
									class="_modified"
									>{{ i18n.ts.modified }}</span
								></template
							>
...
const enableStatsForFederatedInstances = ref(
	meta.enableStatsForFederatedInstances,
);
const enableChartsForFederatedInstances = ref(
	meta.enableChartsForFederatedInstances,
);
	...
	async (state) => {
		await os.apiWithDialog("admin/update-meta", {
			...
			perRemoteUserUserTimelineCacheMax:
				state.perRemoteUserUserTimelineCacheMax,
