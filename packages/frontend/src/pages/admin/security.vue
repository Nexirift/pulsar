		...
		>
			<div class="_gaps_m">
				<MkFolder v-if="meta.federation !== 'none'">
					...
					<template #suffix>{{
						meta.allowUnsignedFetch !== "always"
							? i18n.ts.enabled
							: i18n.ts.disabled
					}}</template>
				...
				<MkFolder>
					...
					<template
						v-if="emailValidationForm.savedState.enableActiveEmailValidation"
						#suffix
						>Enabled</template
					>
					...
					<div class="_gaps_m">
						...
						<MkSwitch
							v-model="emailValidationForm.state.enableActiveEmailValidation"
						>
				...
				<MkFolder>
					...
					<div class="_gaps_m">
						<MkTextarea
							v-model="bannedEmailDomainsForm.state.bannedEmailDomains"
						>
				...
				<MkFolder>
					...
					<template v-if="ipLoggingForm.savedState.enableIpLogging" #suffix
						>Enabled</template
					>
					<template v-else #suffix>Disabled</template>
