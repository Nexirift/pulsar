...
<template>
	<PageWithHeader :actions="headerActions" :tabs="headerTabs">
		<div class="_spacer" style="--MI_SPACER-w: 700px">
			<div class="_gaps">
				<div class="_buttons">
					<MkButton primary rounded @click="edit"
						><i class="ti ti-pencil"></i> {{ i18n.ts.edit }}</MkButton
					>
					<MkButton secondary rounded @click="clone"
						><i class="ti ti-copy"></i> {{ i18n.ts.clone }}</MkButton
					>
					<MkButton danger rounded @click="del"
				...
				<MkFolder v-if="role.target === 'manual'" defaultOpen>
					...
					<div class="_gaps">
						<MkButton primary rounded @click="assign"
								...
								<div class="_gaps_s">
									<div
										...
										:class="[
											$style.userItem,
											{
												[$style.userItemOpend]: expandedItems.includes(item.id),
											},
										]"
									>
										<div :class="$style.userItemMain">
											...
											<button
												class="_button"
												:class="$style.unassign"
												@click="unassign(item.user, $event)"
											>
												<i class="ti ti-x"></i>
											</button>
										</div>
