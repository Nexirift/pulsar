...
function chatPage(...args: Parameters<typeof page>) {
	return $i?.policies.chatAvailability !== "unavailable"
		? page(...args)
...
export const ROUTE_DEF = [
	...
	},
	{
		...
		children: [
			...
			},
			{
				...
				component: page(
					() => import("@/pages/settings/mobile-footer-menu.vue"),
				),
			},
			{
				path: "/navbar",
			...
			},
			{
				path: "/my-apps",
				name: "my-apps",
				component: page(() => import("@/pages/settings/my-apps.vue")),
			},
			{
	...
	},
	{
		...
		component: iAmModerator
			? page(() => import("@/pages/admin-user.vue"))
			: page(() => import("@/pages/not-found.vue")),
	},
	{
	...
	},
	{
		...
		children: [
			...
			},
			{
				...
				name: "emojis2",
				component: page(
					() => import("@/pages/admin/custom-emojis-manager2.vue"),
				),
			},
			{
				path: "/avatar-decorations",
			...
			},
			{
				...
				component: page(
					() => import("@/pages/admin/abuse-report/notification-recipient.vue"),
				),
			},
			{
				path: "/system-webhook",
