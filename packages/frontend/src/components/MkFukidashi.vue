		...
		<div :class="$style.bg">
			...
			>
				<g transform="translate(-173.71 -87.184)">
					<path
						d="m188.19 87.657c-1.469 2.3218-3.9315 3.8312-6.667 4.0865-2.2309-1.7379-4.9781-2.6816-7.8061-2.6815h-5.1e-4v12.702h12.702v-5.1e-4c2e-5 -1.9998-0.47213-3.9713-1.378-5.754 2.0709-1.6834 3.2732-4.2102 3.273-6.8791-6e-5 -0.49375-0.0413-0.98662-0.1235-1.4735z"
						fill-rule="evenodd"
...
.root {
	...
	&.left {
		...
		&.negativeMargin {
			margin-left: calc(calc(var(--fukidashi-radius) * 0.13) * -1);
		}
	}

	&.right {
		padding-right: calc(var(--fukidashi-radius) * 0.13);

		&.negativeMargin {
			margin-right: calc(calc(var(--fukidashi-radius) * 0.13) * -1);
		}
	}
}
