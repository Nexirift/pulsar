...
<template>
	...
	>
		<TransitionGroup
			:duration="
				(prefer.s.animation && props.transition?.duration) || undefined
			"
			:enterActiveClass="
				(prefer.s.animation && props.transition?.enterActiveClass) || undefined
			"
			:leaveActiveClass="
				(prefer.s.animation &&
					(props.transition?.leaveActiveClass ??
						$style.transition_leaveActive)) ||
				undefined
			"
			:enterFromClass="
				(prefer.s.animation && props.transition?.enterFromClass) || undefined
			"
			:leaveToClass="
				(prefer.s.animation && props.transition?.leaveToClass) || undefined
			"
			:enterToClass="
				(prefer.s.animation && props.transition?.enterToClass) || undefined
			"
			:leaveFromClass="
				(prefer.s.animation && props.transition?.leaveFromClass) || undefined
			"
		>
			<canvas
				v-show="hide"
