...
<template>
	...
	>
		<path
			d="M63,63L96,96"
			style="--l: 47; --duration: 0.3s"
			:class="[$style.line, $style.anim]"
		/>
		<path
			d="M96,63L63,96"
			style="--l: 47; --duration: 0.3s; --delay: 0.2s"
			:class="[$style.line, $style.anim]"
		/>
		<circle
			cx="80"
...
.anim {
	...
	animation: line-animation var(--duration, 0.5s) cubic-bezier(0, 0, 0.25, 1) 1
		forwards;
...
.fade {
	opacity: 0;
	animation: fade-in var(--duration, 0.5s) cubic-bezier(0, 0, 0.25, 1) 1
		forwards;
	animation-delay: var(--delay, 0s);
}
