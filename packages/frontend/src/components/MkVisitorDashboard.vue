...
<template>
	<div v-if="instance" :class="$style.root">
		<div :class="[$style.main, $style.panel]">
			<img
				:src="
					instance.sidebarLogoUrl || instance.iconUrl || '/apple-touch-icon.png'
				"
				alt=""
				:class="instance.sidebarLogoUrl ? $style.wideIcon : $style.mainIcon"
			/>
			<button
				class="_button _acrylic"
				:class="$style.mainMenu"
				@click="showMenu"
			>
			...
			<div :class="$style.mainFg">
				...
				<div :class="$style.mainAbout">
					...
					<div
						v-html="
							sanitizeHtml(instance.description) || i18n.ts.headlineMisskey
						"
					></div>
				</div>
				<div
					v-if="instance.about && instance.description !== instance.about"
					:class="$style.showMore"
				>
					<p>
						<a href="/about">{{ i18n.ts.showMore }}</a>
					</p>
				</div>
				<div
					v-if="instance.disableRegistration || instance.federation !== 'all'"
					:class="$style.mainWarn"
					class="_gaps_s"
				>
				...
				<div class="_gaps_s" :class="$style.mainActions">
					...
					>
					<MkButton
						v-if="instance.policies.ltlAvailable"
						:class="$style.mainAction"
						full
						rounded
						link
