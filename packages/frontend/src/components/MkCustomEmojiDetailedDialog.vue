			...
			<div class="_spacer">
				<div style="display: flex; flex-direction: column; gap: 1em">
					...
					<MkKeyValue>
						...
						<template #value
							><Mfm :text="emoji.license ?? i18n.ts.none"
						/></template>
					</MkKeyValue>
...
.emojiImgWrapper {
	...
	background-image: repeating-linear-gradient(
		...
		transparent,
		transparent 8px,
		light-dark(rgba(0, 0, 0, 0.05), rgba(255, 255, 255, 0.05)) 8px,
		light-dark(rgba(0, 0, 0, 0.05), rgba(255, 255, 255, 0.05)) 14px
	);
