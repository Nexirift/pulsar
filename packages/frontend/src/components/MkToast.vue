...
<template>
	<div>
		<Transition
			:enterActiveClass="
				prefer.s.animation ? $style.transition_toast_enterActive : ''
			"
			:leaveActiveClass="
				prefer.s.animation ? $style.transition_toast_leaveActive : ''
			"
			:enterFromClass="
				prefer.s.animation ? $style.transition_toast_enterFrom : ''
			"
