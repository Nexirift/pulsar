...
<template>
	<div ref="rootEl" :class="$style.root">
		...
		<Transition
			:enterActiveClass="
				prefer.s.animation ? $style.folderToggleEnterActive : ''
			"
			:leaveActiveClass="
				prefer.s.animation ? $style.folderToggleLeaveActive : ''
			"
...
.folderToggleEnterActive,
.folderToggleLeaveActive {
	overflow-y: clip;
	transition:
		opacity 0.5s,
...
.header {
	...
	background-color: color(
		from v-bind("parentBg ?? 'var(--MI_THEME-bg)'") srgb r g b / 0.85
	);
}
