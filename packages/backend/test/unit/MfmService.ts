...
describe("MfmService", () => {
	...
	describe("toHtml", () => {
		...
		test("escape", () => {
			const input = "```\n<p>Hello, world!</p>\n```";
			const output =
				"<p><pre><code>&lt;p&gt;Hello, world!&lt;/p&gt;</code></pre></p>";
			assert.equal(mfmService.toHtml(mfm.parse(input)), output);
		});
		...
		test("ruby", () => {
			...
			const output =
				"<p><ruby>some<rp>(</rp><rt>text</rt><rp>)</rp></ruby></p>";
			assert.equal(mfmService.toHtml(mfm.parse(input)), output);
		});
		...
		test("ruby2", () => {
			const input = "$[ruby *some text* ignore me]";
			const output =
				"<p><ruby><i>some text</i><rp>(</rp><rt>ignore me</rt><rp>)</rp></ruby></p>";
			assert.equal(mfmService.toHtml(mfm.parse(input)), output);
		});
		...
		test("ruby 3", () => {
			...
			const output =
				"<p><ruby><span><i>some</i> text</span><rp>(</rp><rt>ignore me</rt><rp>)</rp></ruby></p>";
			assert.equal(mfmService.toHtml(mfm.parse(input)), output);
		});
	...
	describe("toMastoApiHtml", () => {
		...
		test("ruby", async () => {
			const input = "$[ruby $[group *some* text] ignore me]";
			const output =
				"<p><ruby><span><span>*some*</span> text</span><rp>(</rp><rt>ignore me</rt><rp>)</rp></ruby></p>";
	...
	describe("fromHtml", () => {
		...
		test("block element", () => {
			assert.deepStrictEqual(
				mfmService.fromHtml("<div>a</div><div>b</div>"),
				"a\nb",
			);
		});
		...
		test("inline element", () => {
			assert.deepStrictEqual(
				mfmService.fromHtml("<ul><li>a</li><li>b</li></ul>"),
				"a\nb",
			);
		});
		...
		test("block code", () => {
			assert.deepStrictEqual(
				mfmService.fromHtml("<pre><code>a\nb</code></pre>"),
				"```\na\nb\n```",
			);
		});
		...
		test("quote", () => {
			assert.deepStrictEqual(
				mfmService.fromHtml("<blockquote>a\nb</blockquote>"),
				"> a\n> b",
			);
		});
		...
		test("br", () => {
			assert.deepStrictEqual(
				mfmService.fromHtml("<p>abc<br><br/>d</p>"),
				"abc\n\nd",
			);
		});
		...
		test("link with no url", () => {
			assert.deepStrictEqual(
				mfmService.fromHtml('<p>a <a href="b">c</a> d</p>'),
				"a [c](b) d",
			);
		});
		...
		test("link without href", () => {
			assert.deepStrictEqual(
				mfmService.fromHtml("<p>a <a>c</a> d</p>"),
				"a c d",
			);
		});
		...
		test("ruby", () => {
			assert.deepStrictEqual(
				mfmService.fromHtml(
					"<p>a <ruby>Misskey<rp>(</rp><rt>ミスキー</rt><rp>)</rp></ruby> b</p>",
				),
		...
		test("ruby with spaces", () => {
			assert.deepStrictEqual(
				mfmService.fromHtml(
					"<p>a <ruby>Miss key<rp>(</rp><rt>ミスキー</rt><rp>)</rp> b</ruby> c</p>",
				),
				"a $[ruby $[group Miss key] ミスキー] b c",
			);
			assert.deepStrictEqual(
				mfmService.fromHtml(
					"<p>a <ruby>Misskey<rp>(</rp><rt>ミス キー</rt><rp>)</rp> b</ruby> c</p>",
				),
		...
		test("ruby with other inline tags", () => {
			assert.deepStrictEqual(
				mfmService.fromHtml(
					"<p>a <ruby><strong>Misskey</strong><rp>(</rp><rt>ミスキー</rt><rp>)</rp> b</ruby> c</p>",
				),
				"a $[ruby **Misskey** ミスキー] b c",
			);
		});
		...
		test("ruby", () => {
			assert.deepStrictEqual(
				mfmService.fromHtml(
					"<ruby> <i>some</i> text <rp>(</rp><rt>ignore me</rt><rp>)</rp> and <rt>more</rt></ruby>",
				),
