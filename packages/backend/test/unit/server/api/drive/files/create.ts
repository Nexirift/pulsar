...
describe("/drive/files/create", () => {
	...
	beforeAll(async () => {
		...
		const userProfilesRepository = module.get<UserProfilesRepository>(
		...
		const driveFoldersRepository = module.get<DriveFoldersRepository>(
			DI.driveFoldersRepository,
		);
