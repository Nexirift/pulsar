...
export class MutingNotificationTypes1695605508898 {
	...
	async up(queryRunner) {
		...
		await queryRunner.query(
			`CREATE TYPE "public"."user_profile_mutingnotificationtypes_enum" AS ENUM('note', 'follow', 'mention', 'reply', 'renote', 'quote', 'reaction', 'pollEnded', 'receiveFollowRequest', 'followRequestAccepted', 'achievementEarned', 'app', 'test', 'pollVote', 'groupInvited')`,
		);
		await queryRunner.query(
