...
export class Fix1690417561187 {
	...
	async up(queryRunner) {
		await queryRunner.query(
			`DROP INDEX "public"."IDX_2cd3b2a6b4cf0b910b260afe08"`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`COMMENT ON COLUMN "user"."isRoot" IS 'Whether the User is the root.'`,
		);
		await queryRunner.query(
			`COMMENT ON COLUMN "ad"."startsAt" IS 'The expired date of the Ad.'`,
		);
		await queryRunner.query(
			`ALTER TABLE "antenna" ALTER COLUMN "lastUsedAt" DROP DEFAULT`,
		);
		await queryRunner.query(
			`ALTER TABLE "meta" ALTER COLUMN "mascotImageUrl" DROP DEFAULT`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE INDEX "IDX_3fcc2c589eaefc205e0714b99c" ON "ad" ("startsAt") `,
		);
		await queryRunner.query(
			`CREATE UNIQUE INDEX "IDX_c71faf11f0a28a5c0bb506203c" ON "channel_favorite" ("userId", "channelId") `,
		);
		await queryRunner.query(
			`CREATE INDEX "IDX_f7b9d338207e40e768e4a5265a" ON "instance" ("firstRetrievedAt") `,
		);
		await queryRunner.query(
	...
	async down(queryRunner) {
		...
		await queryRunner.query(
			`DROP INDEX "public"."IDX_f7b9d338207e40e768e4a5265a"`,
		);
		await queryRunner.query(
			`DROP INDEX "public"."IDX_c71faf11f0a28a5c0bb506203c"`,
		);
		await queryRunner.query(
			`DROP INDEX "public"."IDX_3fcc2c589eaefc205e0714b99c"`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "meta" ALTER COLUMN "mascotImageUrl" SET DEFAULT '/assets/ai.png'`,
		);
		await queryRunner.query(
			`ALTER TABLE "antenna" ALTER COLUMN "lastUsedAt" SET DEFAULT '2023-04-25 06:51:20.985478+00'`,
		);
		await queryRunner.query(`COMMENT ON COLUMN "ad"."startsAt" IS NULL`);
		await queryRunner.query(
			`COMMENT ON COLUMN "user"."isRoot" IS 'Whether the User is the admin.'`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE INDEX "IDX_2cd3b2a6b4cf0b910b260afe08" ON "instance" ("firstRetrievedAt") `,
		);
	}
}
