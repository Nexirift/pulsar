...
export class cleanup1675404035646 {
	...
	async down(queryRunner) {
		...
		await queryRunner.query(
			`ALTER TABLE "meta" ADD "discordClientSecret" character varying(128)`,
		);
		await queryRunner.query(
			`ALTER TABLE "meta" ADD "discordClientId" character varying(128)`,
		);
		await queryRunner.query(
			`ALTER TABLE "meta" ADD "githubClientSecret" character varying(128)`,
		);
		await queryRunner.query(
			`ALTER TABLE "meta" ADD "githubClientId" character varying(128)`,
		);
		await queryRunner.query(
			`ALTER TABLE "meta" ADD "twitterConsumerSecret" character varying(128)`,
		);
		await queryRunner.query(
			`ALTER TABLE "meta" ADD "twitterConsumerKey" character varying(128)`,
		);
		await queryRunner.query(
