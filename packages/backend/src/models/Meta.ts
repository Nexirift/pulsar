...
import {
	type InstanceUnsignedFetchOption,
	instanceUnsignedFetchOptions,
} from "@/const.js";
...
export class MiMeta {
	...
	public disableInactivity: boolean;
	...
	@Column("varchar", {
		length: 1024,
		default: "https://git.codeguilds.org/Nexirift/pulsar",
		nullable: true,
	})
	...
	@Column("varchar", {
		length: 1024,
		default: "https://git.codeguilds.org/Nexirift/pulsar/issues/new",
		nullable: true,
	})
	...
	@Column("varchar", {
		...
		default: "{}",
		comment:
			"An array of URL strings or regex that can be used to omit warnings about redirects to external sites. Separate them with spaces to specify AND, and enclose them with slashes to specify regular expressions. Each item is regarded as an OR.",
	})
