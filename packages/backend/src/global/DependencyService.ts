...
export class DependencyService {
	protected readonly dependencyVersionCache: ManagedMemoryKVCache<
		string | null
	>;

	constructor(cacheManagementService: CacheManagementService) {
		this.dependencyVersionCache = cacheManagementService.createMemoryKVCache<
			string | null
		>("dependencyVersion", Infinity);
	}
	 ...
	 */
	@bindThis
	public async getDependencyVersion(
		dependency: string,
	): Promise<string | null> {
