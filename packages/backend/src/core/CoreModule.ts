...
const $AbuseReportService: Provider = {
	provide: "AbuseReportService",
	useExisting: AbuseReportService,
};
const $AbuseReportNotificationService: Provider = {
	provide: "AbuseReportNotificationService",
	useExisting: AbuseReportNotificationService,
};
const $AccountMoveService: Provider = {
	provide: "AccountMoveService",
	useExisting: AccountMoveService,
};
const $AccountUpdateService: Provider = {
	provide: "AccountUpdateService",
	useExisting: AccountUpdateService,
};
const $AnnouncementService: Provider = {
...
const $ApLogService: Provider = {
	provide: "ApLogService",
	useExisting: ApLogService,
};
const $AppLockService: Provider = {
	provide: "AppLockService",
	useExisting: AppLockService,
};
const $AchievementService: Provider = {
	provide: "AchievementService",
	useExisting: AchievementService,
};
const $AvatarDecorationService: Provider = {
	provide: "AvatarDecorationService",
	useExisting: AvatarDecorationService,
};
...
const $NoteEditService: Provider = {
	provide: "NoteEditService",
	useExisting: NoteEditService,
};
const $NoteDeleteService: Provider = {
	provide: "NoteDeleteService",
	useExisting: NoteDeleteService,
};
const $LatestNoteService: Provider = {
	provide: "LatestNoteService",
	useExisting: LatestNoteService,
};
...
const $SystemAccountService: Provider = {
	provide: "SystemAccountService",
	useExisting: SystemAccountService,
};
...
const $UserKeypairService: Provider = {
	provide: "UserKeypairService",
	useExisting: UserKeypairService,
};
...
const $UserRenoteMutingService: Provider = {
	provide: "UserRenoteMutingService",
	useExisting: UserRenoteMutingService,
};
const $UserSearchService: Provider = {
	provide: "UserSearchService",
	useExisting: UserSearchService,
};
const $UserSuspendService: Provider = {
	provide: "UserSuspendService",
	useExisting: UserSuspendService,
};
const $UserAuthService: Provider = {
	provide: "UserAuthService",
	useExisting: UserAuthService,
};
const $CollapsedQueueService: Provider = {
	provide: "CollapsedQueueService",
	useExisting: CollapsedQueueService,
};
const $VideoProcessingService: Provider = {
	provide: "VideoProcessingService",
	useExisting: VideoProcessingService,
};
const $UserWebhookService: Provider = {
	provide: "UserWebhookService",
	useExisting: UserWebhookService,
};
const $SystemWebhookService: Provider = {
	provide: "SystemWebhookService",
	useExisting: SystemWebhookService,
};
const $WebhookTestService: Provider = {
	provide: "WebhookTestService",
	useExisting: WebhookTestService,
};
...
const $FlashService: Provider = {
	provide: "FlashService",
	useExisting: FlashService,
};
const $SearchService: Provider = {
	provide: "SearchService",
	useExisting: SearchService,
};
const $ClipService: Provider = {
	provide: "ClipService",
	useExisting: ClipService,
};
const $FeaturedService: Provider = {
	provide: "FeaturedService",
	useExisting: FeaturedService,
};
const $FanoutTimelineService: Provider = {
	provide: "FanoutTimelineService",
	useExisting: FanoutTimelineService,
};
const $FanoutTimelineEndpointService: Provider = {
	provide: "FanoutTimelineEndpointService",
	useExisting: FanoutTimelineEndpointService,
};
const $ChannelFollowingService: Provider = {
	provide: "ChannelFollowingService",
	useExisting: ChannelFollowingService,
};
const $ChatService: Provider = {
	provide: "ChatService",
	useExisting: ChatService,
};
const $RegistryApiService: Provider = {
	provide: "RegistryApiService",
	useExisting: RegistryApiService,
};
const $ReversiService: Provider = {
	provide: "ReversiService",
	useExisting: ReversiService,
};
const $InstanceStatsService = {
	provide: "InstanceStatsService",
	useExisting: InstanceStatsService,
};
const $NoteVisibilityService: Provider = {
	provide: "NoteVisibilityService",
	useExisting: NoteVisibilityService,
};
...
const $PerUserPvChart: Provider = {
	provide: "PerUserPvChart",
	useExisting: PerUserPvChart,
};
...
const $AnnouncementEntityService: Provider = {
	provide: "AnnouncementEntityService",
	useExisting: AnnouncementEntityService,
};
const $AbuseReportNotificationRecipientEntityService: Provider = {
	provide: "AbuseReportNotificationRecipientEntityService",
	useExisting: AbuseReportNotificationRecipientEntityService,
};
...
const $ChatEntityService: Provider = {
	provide: "ChatEntityService",
	useExisting: ChatEntityService,
};
...
const $InviteCodeEntityService: Provider = {
	provide: "InviteCodeEntityService",
	useExisting: InviteCodeEntityService,
};
...
const $RenoteMutingEntityService: Provider = {
	provide: "RenoteMutingEntityService",
	useExisting: RenoteMutingEntityService,
};
...
const $FlashEntityService: Provider = {
	provide: "FlashEntityService",
	useExisting: FlashEntityService,
};
const $FlashLikeEntityService: Provider = {
	provide: "FlashLikeEntityService",
	useExisting: FlashLikeEntityService,
};
const $RoleEntityService: Provider = {
	provide: "RoleEntityService",
	useExisting: RoleEntityService,
};
const $ReversiGameEntityService: Provider = {
	provide: "ReversiGameEntityService",
	useExisting: ReversiGameEntityService,
};
const $MetaEntityService: Provider = {
	provide: "MetaEntityService",
	useExisting: MetaEntityService,
};
const $SystemWebhookEntityService: Provider = {
	provide: "SystemWebhookEntityService",
	useExisting: SystemWebhookEntityService,
};
...
const $JsonLdService: Provider = {
	provide: "JsonLdService",
	useExisting: JsonLdService,
};
const $RemoteLoggerService: Provider = {
	provide: "RemoteLoggerService",
	useExisting: RemoteLoggerService,
};
const $RemoteUserResolveService: Provider = {
	provide: "RemoteUserResolveService",
	useExisting: RemoteUserResolveService,
};
...
const $ApUtilityService: Provider = {
	provide: "ApUtilityService",
	useExisting: ApUtilityService,
};
//#endregion

const $SponsorsService: Provider = {
	provide: "SponsorsService",
	useExisting: SponsorsService,
};

@Module({
	imports: [GlobalModule, QueueModule],
	providers: [
		AbuseReportService,
