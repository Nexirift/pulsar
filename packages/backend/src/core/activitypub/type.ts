...
export function getApId(
	...
	if (id == null) {
		...
		throw new IdentifiableError(
			"ad2dc287-75c1-44c4-839d-3d2e64576675",
			message,
		);
	}
 ...
 */
export function getNullableApId(
...
export const isOrderedCollectionPage = (
	object: IObject,
): object is IOrderedCollectionPage =>
	getApType(object) === "OrderedCollectionPage";

export const isCollectionOrOrderedCollection = (
	object: IObject,
): object is AnyCollection =>
	isCollection(object) ||
	isOrderedCollection(object) ||
	isCollectionPage(object) ||
	isOrderedCollectionPage(object);
...
export const isApObject = (object: string | IObject): object is IObject =>
...
export const isDislike = (object: IObject): object is IDislike =>
	getApType(object) === "Dislike";
...
export const isNote = (object: IObject): object is IPost =>
	getApType(object) === "Note";
