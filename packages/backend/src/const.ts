...
export const instanceUnsignedFetchOptions = [
	"never",
	"always",
	"essential",
] as const;
export type InstanceUnsignedFetchOption =
	(typeof instanceUnsignedFetchOptions)[number];

export const userUnsignedFetchOptions = [
	"never",
	"always",
	"essential",
	"staff",
