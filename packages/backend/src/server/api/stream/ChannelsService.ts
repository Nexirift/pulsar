...
export class ChannelsService {
	...
	public getChannelService(name: string): MiChannelService<boolean> {
		switch (name) {
			...
			case "bubbleTimeline":
				return this.bubbleTimelineChannelService;
			case "userList":
			...
			case "chatUser":
				return this.chatUserChannelService;
			case "chatRoom":
				return this.chatRoomChannelService;
			case "reversi":
				return this.reversiChannelService;
			case "reversiGame":
				return this.reversiGameChannelService;
