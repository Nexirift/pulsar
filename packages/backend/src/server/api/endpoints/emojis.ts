...
export default class extends Endpoint<typeof meta, typeof paramDef> {
	...
	private readonly localEmojiIdsCache: ManagedMemorySingleCache<
		MiEmoji["id"][]
	>;
	...
	constructor(
		...
		super(meta, paramDef, async (ps, me) => {
			...
			const emojis =
				await this.customEmojiService.emojisByIdCache.fetchMany(emojiIds);
		...
		this.localEmojiIdsCache = cacheManagementService.createMemorySingleCache<
			MiEmoji["id"][]
		>("localEmojis", 1000 * 2);
	}
}
