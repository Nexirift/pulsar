...
export default class extends Endpoint<typeof meta, typeof paramDef> {
	...
	constructor(
		...
		super(meta, paramDef, async (ps, me) => {
			...
			const iAmModeratorOrTarget =
				me && (me.id === ps.userId || (await this.roleService.isModerator(me)));
			const iAmFollowingOrTarget =
				me &&
				(me.id === ps.userId ||
					(await this.cacheService.isFollowing(me.id, ps.userId)));
			...
			const chart = await this.perUserFollowingChart.getChart(
				ps.span,
				ps.limit,
