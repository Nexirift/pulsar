...
export default class extends Endpoint<typeof meta, typeof paramDef> {
	...
	constructor(
		...
		super(meta, paramDef, async (ps, me) => {
			...
			if (
				ps.rejectReports != null &&
				instance.rejectReports !== ps.rejectReports
			) {
				const message = ps.rejectReports
			...
			if (
				ps.rejectQuotes != null &&
				instance.rejectQuotes !== ps.rejectQuotes
			) {
				const message = ps.rejectReports
			...
			if (
				ps.moderationNote != null &&
				instance.moderationNote !== ps.moderationNote
			) {
